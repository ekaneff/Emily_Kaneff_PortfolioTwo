...
//introduction
    console.log("You arrive at the covenant, the home of Justin, the mage that has left in search of something. You are not " +
...
//first encounter
    ...
    function Rate() {
        var input, rating;
        input = prompt("What would you rate this game?");
        rating = (input < 3) ? "You did not seem to enjoy this game.":"You seemed to enjoy this game.";
        console.log(rating);
    }
