...
for (var i = 0; i < data.results.forecast.length; i++){
    console.log("Today is " + data.results.forecast[i].day + ". The high is " + data.results.forecast[i].high + ". The low is " +
        data.results.forecast[i].low + ". It will be " + data.results.forecast[i].text + ".");
}

// 3. Console.log each of the employees showing their full names (from the object "employees"
// and jobs (from the object "people").

for (var i = 0; i < myJSON.people.length;i++ ){
